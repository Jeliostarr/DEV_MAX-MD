...
const ownerNumber = ['256766238915']

//===================SESSION-AUTH============================
if (!fs.existsSync(__dirname + '/sessions/creds.json')) {
if(!config.SESSION_ID) return console.log('Please add your session to SESSION_ID env !!')
const sessdata = config.SESSION_ID.replace("DEV~", '');
...
console.log("CONNECTING DEV_MAX-MD 🧬...");
...
let up = `*╭──────────────●●►*
> *➺ DEV_MAX-MD ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ your name ✅*
...
app.get("/", (req, res) => {
res.send("HEY, DEV_MAX-MD STARTED ✅");
});
